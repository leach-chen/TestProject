...
public class ScrollDelView extends LinearLayout {
    ...
    public ScrollDelView(Context context) {
        this(context,null);
    }

    public ScrollDelView(Context context, @Nullable AttributeSet attrs) {
    ...
    public ScrollDelView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
